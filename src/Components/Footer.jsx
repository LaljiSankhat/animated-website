...
const Footer = () => {
  return (
    <div className="w-full h-screen bg-zinc-900 px-10 py-2 flex">
      <div className="w-1/2 h-full relative">
        <h1 className='text-[7vw] leading-[6vw] -tracking-[.7vw] font-["jetbrains_mono"] font-semibold'>
          EYE-
        </h1>
        <h1 className='text-[7vw] leading-[6vw] -tracking-[.7vw] font-["jetbrains_mono"] font-semibold'>
          OPENING
        </h1>
        <div className="ochi absolute left-3 top-[91.5%]">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
      ...
      <div className="w-1/2">
        ...
        <div className="dets font-['Neue_Montreal'] mt-10">
          <a className='block text-medium font-light' href="#">Facebook</a>
          <a className='block text-medium font-light' href="#">Instagram</a>
          <a className='block text-medium font-light' href="#">Twitter</a>
        </div>
      </div>
    </div>
  );
